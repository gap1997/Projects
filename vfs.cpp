...
{
printf("Description : Used to data from regulr file\n");
printf("Usage : read File_Name No_Of_Bytes_To_Read\n");
}
else if(strcmp(name,"write") == 0)
{
printf("Description : Used write into regular file\n");
printf("Usage : write File_Name\n After this entered the data that we want to write\n");
}
...
printf("exit : To termonate file system\n");
printf("stat : To Display information of file using name\n");
printf("fstat : To Display information of file using fle descriptor\n");
